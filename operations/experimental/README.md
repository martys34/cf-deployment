...
| [`disable-consul-windows2016.yml`](disable-consul-windows2016.yml) | **DEPRECATED: Consul has been removed from cf-deployment** Consul has been removed. Removes `consul` job from `windows2016-cell` instance group and prevents the Windows 2016 cell rep from registering itself as a service with Consul | Requires `windows2016-cell.yml` or `windows1803-cell.yml` |
